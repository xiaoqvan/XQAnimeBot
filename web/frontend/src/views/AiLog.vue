  ...
  <div>
    <div class="head">
      ...
      <div class="tabs">
        ...
        <button class="tab" :class="{ active: scene === 'bangumi_match' }" @click="switchScene('bangumi_match')">番剧匹配</button>
        <button class="tab" :class="{ active: scene === 'episode_match' }" @click="switchScene('episode_match')">集数匹配</button>
        <button class="tab" :class="{ active: scene === 'episode_extract' }" @click="switchScene('episode_extract')">集数提取</button>
      </div>
    </div>
